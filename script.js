...
window.onclick = function(event) {
  ...
  const projects = {
    ...
    project6: { title: 'Clover Ice cream Web UI Prototype', img: 'images/project6.jpg', tools: 'Figma', desc: 'A playful and interactive ice cream website UI with vibrant colors, smooth animations, and a user-friendly layout for an engaging experience across devices.', repo: 'https://www.figma.com/design/Hc4lKHEuI5tR95jtJjEoza/Untitled?node-id=0-1&t=Rf6ttn2wreIcogSr-1' },
  };
